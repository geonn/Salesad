...
- (void)setViewfinderHeight:(float)h
            ...
            landscapeHeight:(float)lH
             landscapeWidth:(float)lW SBS_SWIFT_NAME(setViewfinder(height:width:landscapeHeight:landscapeWidth:));

/**
 * \brief Sets the size of the viewfinder relative to the size of the screen size in portrait orientation.
 *
 * Changing this value does not(!) affect the area in which barcodes are successfully recognized.
 * It only changes the size of the box drawn onto the scan screen. To restrict the active scanning area,
 * use the methods listed below.
...
/**
 * \brief Sets the size of the viewfinder relative to the size of the screen size in landscape orientation.
 *
 * Changing this value does not(!) affect the area in which barcodes are successfully recognized.
 * It only changes the size of the box drawn onto the scan screen. To restrict the active scanning area,
 * use the methods listed below.

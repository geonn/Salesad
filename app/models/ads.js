	...
	extendCollection: function(Collection) {
		_.extend(Collection.prototype, {
			...
			getBannerList: function(){
	            ...
	            d = d.split(" ")[0];
				var sql = "select * from ads where (','||featured_date||',') LIKE '%,"+d+",%' AND ( expired_date >= date('now') OR expired_date = '0000-00-00') AND (active_date <= date('now') OR active_date = '0000-00-00') AND sales_to >= date('now') AND status = 1 ORDER BY updated DESC";
